...
* To view the contents of the ``nodeinfo`` table: ``select * from cluster.nodeinfo;`` ::
        ...
        ----+-------------+--------+----------------+-------------------+--------------+------------+------------+------------------------------------------+----------------+-----------+-----------------+---------------+---------------+---------------------+-----------+-----------+-------------+-------------+-------+---------+-----------+-----------+
          1 | xxxxxxx     | oim    | newoim.new.dev | 00:0a:f7:dc:11:42 | 10.5.255.254 |            |            |                                          |                |           |                 |               |               |                     |           |           |             |             |       |         |           |           |
          2 | xxxxxxx     | node1  | node1.new.dev  | c4:cb:e1:b5:70:44 | 10.5.0.1     | 10.30.0.12 |  grp1      | service_kube_control_plane,service_etcd  |  svc_cluster   |           |  SU-1-RAC-1     |  x86          | powering-on   | mapping             |           |           |             |             | amd   |  amd    |  2        |   1       |
          3 | xxxxxxx     | node2  | node2.new.dev  | f4:02:70:b8:bc:2a | 10.5.0.2     | 10.30.0.10 |  grp2      | service_kube_node                        |  svc_cluster   |           |  SU-1-RAC-1     |  x86          | booted        | mapping             |           |           |             |             | amd   |  amd    |  1        |   1       |
          4 | xxxxxxx     | node3  | node3.new.dev  | f4:02:70:b8:bc:2a | 10.5.0.3     | 10.30.0.11 |  grp3      | default                                  |                |  xxxxxxx  |  SU-1-RAC-1     |  x86          | booted        | mapping             |           |           |             |             | amd   |  amd    |  1        |   1       |                            
